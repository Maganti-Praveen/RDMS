...
const { getUsers, getUser, updateUser, deleteUser, bulkDeleteUsers, getDepartments, uploadProfilePicture, removeProfilePicture } = require('../controllers/userController');
